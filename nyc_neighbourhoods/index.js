...
fs.createReadStream(root + '/meta/wof-neighbourhood-latest.csv')
  ...
  .pipe(filter.obj(function(record) {
    return record.parent_id === '421205775'
  }))
  ...
  .pipe(filter.obj(function(o) {
    return o.properties['mz:tier_locality'] === undefined ||
            o.properties['mz:tier_locality'] < 6 ||
            o.properties['mz:is_funky'] === 1
  }))
  .pipe(sink.obj(function(o) {
    console.log(o.id + ': [' + o.properties['wof:name'] + '](https://whosonfirst.mapzen.com/spelunker/id/' + o.id + '/)')
  }))
  // .pipe(filter.obj(function(o) {
